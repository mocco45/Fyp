...
public class short_form extends AppCompatActivity {
    //location
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_short_form);
...
//Maritual Status
        ...
        btnSendData.setOnClickListener(new View.OnClickListener() {
            ...
            private void toastBtn() {
                ...
                String jinaKamil = jinaKml.getEditText().getText().toString();
...
if (TextUtils.isEmpty(region)){
...
else if (TextUtils.isEmpty(jinaKamil)){
                    jinaKml.setError("please fill full name");
                    jinaKml.requestFocus();
                    return;
                }
    ...
    autoCompleteDeath.requestFocus();
                ...
                Identification identification = new Identification(region, jinaKamil, district, kata, kijiji, streat, relationShip, Gender, Miaka, Albinism, seeing, hearing, working, remebering, selfcare, disability, martualstatus, birthcerticate, educatuion, educatuion_attainment, educatuion_level, dealth, caurseOfdealth, kodi_namba_ya_ulaiya, sehemu_anapoishi_kwa_sasa, sehemu_anapopatikana_sana, miaka_kamili, dealth_occur_during_preg, Dealth_occur_during_child, Agriculture);
